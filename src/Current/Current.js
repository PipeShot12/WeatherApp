...
export default class Current extends Component {
    ...
    render() {
        const countryName = this.props.nameCounty ? this.normalize(this.props.nameCounty) : "Paris"
        const arr = [this.props.tempData]
        let currentTime;
        ...
        return (
            < div className="col-lg-4 col-12 main py-3" style={{ backgroundImage: `linear-gradient(45deg,rgba(102, 28, 41, 0.9)0%,rgba(114,17,54,0.8)100%),url("${this.props.photoCountry}")` }}>
                {currentTemperature}
                {nextTemperature}
            </div>
